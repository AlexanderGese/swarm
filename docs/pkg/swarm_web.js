...
export class Sim {
    ...
    /**
     * @param {number} pieces
     * @param {number} n_peers
     * @param {bigint} seed
     */
    constructor(pieces, n_peers, seed) {
        const ret = wasm.sim_new(pieces, n_peers, seed);
        this.__wbg_ptr = ret;
    ...
    render() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sim_render(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    step() {
        const ret = wasm.sim_step(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('swarm_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
